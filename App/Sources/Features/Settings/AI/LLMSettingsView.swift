...
struct LLMSettingsView: View {
    ...
    @StateObject private var catalog = OpenRouterModelSelectorViewModel()
...
private struct ModelPreviewCard: View {
    ...
    var body: some View {
        if let model {
            ...
            .padding(.leading, 41)   // align with SettingsRow label (badge 29 + spacing 12)
            .padding(.bottom, 4)
